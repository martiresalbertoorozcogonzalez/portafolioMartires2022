    ...
    <div class="container mx-auto max-w-screem-md">
        <div class="flex flex-wrap justify-center">
            ...
            <div class="md:w-1/2 order-1 md:order-2 text-center flex flex-col justify-center px-10 mt-10">
                <h1 class="text-teal-500 text-3xl">🙋🏽‍♂️Bienvenido a la seccion de Administracin</h1>
                <p class="text-xl mt-5 leading-7">Crea una cuenta gratis y administra todo tu portafolio</p>
            </div>
